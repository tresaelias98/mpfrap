...
% Output variables:
    % this code will compute the raw simulated fluorescence recovery curves
    % (with and without noise), and the fit parameters for the diffusion
    % only, convective flow, and shear flow models. There are comments
    % within the code that show where to save each of these variables.
